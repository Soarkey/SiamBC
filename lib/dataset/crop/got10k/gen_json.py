...
json.dump(train, open('/data/dataset/got_10k/train.json', 'w'), indent=4, sort_keys=True)
json.dump(val, open('/data/dataset/got_10k/val.json', 'w'), indent=4, sort_keys=True)
print('done!')
